...
export class Logger {
   ...
   */
  context(...contextObjects: any[]): GradingBotLoggingContext {
    ...
    return context as GradingBotLoggingContext;
  }
 ...
 */
const ContextFields = ['applicationStepResultId', 'applicationStepId', 'batchId', 'taskId'];

export interface GradingBotLoggingContext {
